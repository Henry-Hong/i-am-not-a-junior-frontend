...
function Nt() {
  ...
  function J(n, i, g, b, R) {
    ...
    if (O)
      return O = n, R = R(O), n = b === "" ? "." + z(O, 0) : b, ue(R) ? (g = "", n != null && (g = n.replace(Te, "$&/") + "/"), J(R, i, g, "", function(W) {
        return W;
    ...
    if (O = 0, b = b === "" ? "." : b + ":", ue(n))
      ...
      for (n = w.call(n), T = 0; !(k = n.next()).done; )
        k = k.value, w = b + z(k, T++), O += J(k, i, g, w, R);
    else if (k === "object")
  ...
  return m.Children = { map: U, forEach: function(n, i, g) {
    ...
    if (i != null) {
      if (i.ref !== void 0 && (k = i.ref, O = H.current), i.key !== void 0 && (R = "" + i.key), n.type && n.type.defaultProps)
      ...
      function Re(e, r, a, o, c) {
        ...
        if (f) {
          ...
          if ($e(E)) {
            ...
            E != null && (Ee(E) && (E.key && (!y || y.key !== E.key) && Pe(E.key), E = Cr(
              E,
...
function Ut() {
  if (ht)
    return Ge;
  ht = 1;
  var K = gt(), v = Symbol.for("react.element"), de = Symbol.for("react.fragment"), Q = Object.prototype.hasOwnProperty, pe = K.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, te = { key: !0, ref: !0, __self: !0, __source: !0 };
  function ne(Z, $, ee) {
    ...
    if (Z && Z.defaultProps)
      for (L in $ = Z.defaultProps, $)
        V[L] === void 0 && (V[L] = $[L]);
    return { $$typeof: v, type: Z, key: re, ref: G, props: V, _owner: pe.current };
  }
...
function Yt() {
  return mt || (mt = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var ue = !1, M = !1, H = !1, ce = !1, ve = !1, we;
    we = Symbol.for("react.module.reference");
    function Se(t) {
      return !!(typeof t == "string" || typeof t == "function" || t === Q || t === te || ve || t === pe || t === ee || t === L || ce || t === G || ue || M || H || typeof t == "object" && t !== null && (t.$$typeof === re || t.$$typeof === V || t.$$typeof === ne || t.$$typeof === Z || t.$$typeof === $ || // This needs to include all possible module reference object
      // types supported by any Flight configuration anywhere since
      // we don't know which Flight build this will end up being used
      // with.
    ...
    var J = Object.assign, U = 0, ie, l, fe, Oe, ye, n, i;
    function g() {
    }
...
function zt({
  ...
  const de = v === "primary" ? "blue" : "red";
  return /* @__PURE__ */ Bt.jsx("button", { style: { backgroundColor: de }, children: K });
}
export {
  zt as Button
};
